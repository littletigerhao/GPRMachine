...
# Date      : May/07/2020
# Author    : XHHAO
# Annotation: This file is the core of Gaussian Process Regression.
#===============================================================================
import random
import numpy as np
...
class GeneralGPR():
    #===========================================================================
    #===========================================================================
    def __init__(self, X_train, Y_train, dropout, sigma_n, n_run):
    ...
    def set_init_kernel(self):
        ...
        self.kernel = sigma**2*RBF(length_scale=lsv)
    #===========================================================================
    #===========================================================================
    def set_init_kernel_(self):
        ...
        sigma = np.random.uniform(1500, 2000)
        lsv = np.random.uniform(1500, 2000, x_dim)
        self.kernel_ = sigma**2*RBF(length_scale=lsv)
    #===========================================================================
    #===========================================================================
    def get_kernel(self):
        return self.kernel
    ...
    def Predict(self, X):
        ...
        K[np.diag_indices_from(K)] += self.sigma_n
        L = cholesky(K, lower=True)
